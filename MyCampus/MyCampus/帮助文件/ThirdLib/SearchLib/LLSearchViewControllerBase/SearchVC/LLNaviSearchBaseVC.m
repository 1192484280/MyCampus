...
- (UIScrollView *)myBGScrollView
{
    if (!_myBGScrollView) {
        _myBGScrollView = ({
            UIScrollView *bgScrollView =  [[UIScrollView alloc] initWithFrame:CGRectMake(0,iPhoneX_Top, ScreenWidth,ScreenHeight - (iPhoneX_Top))];
...
-(void)setResultListArray:(NSArray<NSString *> *)resultListArray
{
    ...
    self.resultListView.frame = CGRectMake(0, iPhoneX_Top, self.view.width, ZYHT_ScreenHeight-KeyboardHeightWhenShow-iPhoneX_Top);
