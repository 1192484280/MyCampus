...
- (void)setUI{
    ...
    topHeight.constant = iPhoneX_Top;
    viewHeight.constant = ScreenHeight - (iPhoneX_Top);
    ...
    [noteText wzb_autoHeightWithMaxHeight:ScreenHeight - (iPhoneX_Top) - 200 textViewHeightDidChanged:^(CGFloat currentTextViewHeight){
        NSLog(@"");
