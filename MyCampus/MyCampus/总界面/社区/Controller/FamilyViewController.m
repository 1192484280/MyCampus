...
- (SMPagerTabView *)segmentView {
    if (!_segmentView) {
        self.segmentView = [[SMPagerTabView alloc]initWithFrame:CGRectMake(0, iPhoneX_Top, ScreenWidth, ScreenHeight - (iPhoneX_Top))];
...
- (void)onPicBtn{
    ...
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        [imagePickerVc setDidFinishPickingPhotosHandle:^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
            ...
            PostPicViewController *vc = [[PostPicViewController alloc] init];
            vc.picArr = photos;
