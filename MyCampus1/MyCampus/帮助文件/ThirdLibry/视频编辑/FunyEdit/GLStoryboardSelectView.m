...
- (void)initResourceFormPuzzle
{
    ...
    for (int i = 0; i < [imageNameArray count]; i++)
    {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"selectedd"] forState:UIControlStateSelected];
...
- (void)initResourceFormFilter
{
    ...
    for (int i = 0; i < borderCount; i++)
    {
        ...
        {
            NSString *imageName = [NSString stringWithFormat:@"filter_%i.png", i];
            [button setImage:[UIImage imageNamed:imageName] forState:UIControlStateNormal];
        }
