...
- (UIScrollView *)myBGScrollView
{
    if (!_myBGScrollView) {
        _myBGScrollView = ({
            UIScrollView *bgScrollView =  [[UIScrollView alloc] initWithFrame:CGRectMake(0,NAVBAR_HEIGHT, ScreenWidth,ScreenHeight - (NAVBAR_HEIGHT))];
            bgScrollView.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0];
            bgScrollView.contentSize = CGSizeMake(ScreenWidth, (ScreenHeight) - 60);
...
-(void)setResultListArray:(NSArray<NSString *> *)resultListArray
{
    ...
    self.resultListView.frame = CGRectMake(0, NAVBAR_HEIGHT, self.view.width, ZYHT_ScreenHeight-KeyboardHeightWhenShow-NAVBAR_HEIGHT);
