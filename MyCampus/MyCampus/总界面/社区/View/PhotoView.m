...
- (UIButton *)firstBtn{
    ...
    if (!_firstBtn) {
        ...
        _firstBtn = [[UIButton alloc] initWithFrame:CGRectMake(16, 8, 100, 100)];
...
- (void)refreshUI{
    ...
    for (int i = 0; i < self.photoArr.count; i++) {
        ...
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(116 * i + 16 , 8, 100, 100)];
    ...
    self.sView.contentSize = CGSizeMake((100 + 20) * self.photoArr.count, 0);
