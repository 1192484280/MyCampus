...
- (void)initTimeControl
{
    ...
    _timerControl.titleLabel.text = @"秒";
...
- (void)pressCloseButton
{
    if ([_recorder getVideoCount] > 0)
    {
        NSString *cancel = GBLocalizedString(@"取消");
        NSString *abandon = GBLocalizedString(@"确定");
        NSString *reminder = nil;
        NSString *cancelVideoHint = GBLocalizedString(@"删除当前视频");
